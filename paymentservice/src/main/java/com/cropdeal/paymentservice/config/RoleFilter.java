...
public class RoleFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (path.startsWith("/api/users/internal") || path.startsWith("/api-docs") || path.startsWith("/actuator") || path.startsWith("/api-docs/swagger-config")|| path.startsWith("/swagger-ui")) {
