...
public class RoleFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (path.startsWith("/api/auth") || path.startsWith("/api/users/internal") || path.startsWith("/api-docs") || path.startsWith("/doc")|| path.startsWith("/actuator") || path.startsWith("/swagger-ui")) {
